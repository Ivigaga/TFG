...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_sys_nada = QPushButton(self.page_sys)
        self.controlButtons.addButton(self.btn_sys_nada)
        self.btn_sys_nada.setObjectName(u"btn_sys_nada")
        sizePolicy.setHeightForWidth(self.btn_sys_nada.sizePolicy().hasHeightForWidth())
        self.btn_sys_nada.setSizePolicy(sizePolicy)
        self.btn_sys_nada.setCheckable(True)
        self.btn_sys_nada.setAutoExclusive(True)

        self.gridLayout_sys.addWidget(self.btn_sys_nada, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_sys_nada.setText(QCoreApplication.translate("MainWindow", u"Pensar", None))
        self.btn_sys_nada.setProperty(u"gamepadInput", QCoreApplication.translate("MainWindow", u"SYS_NONE", None))
