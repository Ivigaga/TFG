...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.slider_y.setAutoFillBackground(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pipButton.setText(QCoreApplication.translate("MainWindow", u"Extraer C\u00e1mara", None))
        self.stopButton.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
#if QT_CONFIG(shortcut)
        self.stopButton.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+C", None))
